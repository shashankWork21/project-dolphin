/*
  ...
  - The values [DISCARDED] on the enum `TaskStatusTag` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "TaskStatusTag_new" AS ENUM ('NOT_STARTED', 'IN_PROGEESS', 'COMPLETED', 'ON_HOLD', 'CANCELLED');
