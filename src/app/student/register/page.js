...
export default function StudentRegisterPage() {
  const googleSigninUrl = `${process.env.NEXT_PUBLIC_BASE_URL}/api/auth?scope=EMAIL,PROFILE,OPENID&role=student&redirect_url=${process.env.NEXT_PUBLIC_BASE_URL}/dashboard`;
  return (
